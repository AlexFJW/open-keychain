            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                if (skipMerge || !awaitingMerge) {
                    ...
                    try {
                        ...
                        SaveKeyringResult saveResult = mProviderHelper.saveSecretKeyRing(secretKey,
                        ...
                        SaveKeyringResult saveResult = mProviderHelper.saveSecretKeyRing(canSecretKey.getUncachedKeyRing(),
                                passphrases, new ProgressScaler());
                        if (!saveResult.success()) {
